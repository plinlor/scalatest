 ...
 * '''Recommended Usage''':
 * Use class `fixture.WordSpec` in situations for which <a href="../WordSpec.html">`WordSpec`</a>
 ...
 * more insight into where `fixture.WordSpec` fits in the big picture, see the <a href="../WordSpec.html#withFixtureOneArgTest">`withFixture(OneArgTest)`</a> subsection of the <a href="../WordSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `WordSpec`.''
 * </td></tr></table>
 * 
