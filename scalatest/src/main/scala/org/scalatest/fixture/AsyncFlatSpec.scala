 ...
 * '''Recommended Usage''':
 * Use class `fixture.AsyncFlatSpec` in situations for which <a href="../AsyncFlatSpec.html">`AsyncFlatSpec`</a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. ''Note: `fixture.AsyncFlatSpec` is intended for use in special situations, with class `AsyncFlatSpec` used for general needs. For
 * more insight into where `fixture.AsyncFlatSpec` fits in the big picture, see the <a href="../AsyncFlatSpec.html#withFixtureOneArgAsyncTest">`withFixture(OneArgAsyncTest)`</a> subsection of the <a href="../AsyncFlatSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `AsyncFlatSpec`.''
 * </td></tr></table>
 *
 * Class `fixture.AsyncFlatSpec` behaves similarly to class `org.scalatest.AsyncFlatSpec`, except that tests may have a
