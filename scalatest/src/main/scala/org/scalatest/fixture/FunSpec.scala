 ...
 * '''Recommended Usage''':
 * Use class `fixture.FunSpec` in situations for which <a href="../FunSpec.html">`FunSpec`</a>
 ...
 * more insight into where `fixture.FunSpec` fits in the big picture, see the <a href="../FunSpec.html#withFixtureOneArgTest">`withFixture(OneArgTest)`</a> subsection of the <a href="../FunSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `FunSpec`.''
 * </td></tr></table>
 * 
