 ...
 * '''Recommended Usage''':
 * Use class `fixture.AsyncFunSpec` in situations for which <a href="../AsyncFunSpec.html">`AsyncFunSpec`</a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. ''Note: `fixture.AsyncFunSpec` is intended for use in special situations, with class `AsyncFunSpec` used for general needs. For
 * more insight into where `fixture.AsyncFunSpec` fits in the big picture, see the <a href="../AsyncFunSpec.html#withFixtureOneArgAsyncTest">`withFixture(OneArgAsyncTest)`</a> subsection of the <a href="../AsyncFunSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `AsyncFunSpec`.''
 * </td></tr></table>
 *
 * Class `fixture.AsyncFunSpec` behaves similarly to class `org.scalatest.AsyncFunSpec`, except that tests may have a
