 ...
 * a sister class to <a href="../WordSpec.html">`org.scalatest.WordSpec`</a> that can pass a
 * fixture object into its tests.
 *
 * <a href="WordSpec.html">`fixture.WordSpec`</a> is a class,
 ...
 * overview of `fixture.WordSpec`</a>.
 * 
 *
 * @author Bill Venners
 */
