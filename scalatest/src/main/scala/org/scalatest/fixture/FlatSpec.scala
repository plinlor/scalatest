 ...
 * '''Recommended Usage''':
 * Use class `fixture.FlatSpec` in situations for which <a href="../FlatSpec.html">`FlatSpec`</a>
 ...
 * more insight into where `fixture.FlatSpec` fits in the big picture, see the <a href="../FlatSpec.html#withFixtureOneArgTest">`withFixture(OneArgTest)`</a> subsection of the <a href="../FlatSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `FlatSpec`.''
 * </td></tr></table>
 * 
 ...
 * }}}
 *
 * If a test fails because of an exception, the `OneArgTest` function will result in a [[org.scalatest.Failed Failed]] wrapping the exception.
