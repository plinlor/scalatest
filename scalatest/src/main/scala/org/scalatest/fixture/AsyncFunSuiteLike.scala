 ...
 *
 * <a href="AsyncFunSuite.html">`fixture.AsyncFunSuite`</a> is a class,
 * not a trait, to minimize compile time given there is a slight compiler
 * overhead to mixing in traits compared to extending classes. If you need
 * to mix the behavior of `fixture.AsyncFunSuite` into some other
 * class, you can use this trait instead, because class
 * `fixture.AsyncFunSuite` does nothing more than extend this trait and add a nice `toString` implementation.
 * 
 *
 * See the documentation of the class for a <a href="AsyncFunSuite.html">detailed
 * overview of `fixture.AsyncFunSuite`</a>.
 * 
 *
 * @author Bill Venners
 */
