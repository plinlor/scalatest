 ...
 * '''Recommended Usage''':
 * Use class `fixture.AsyncFeatureSpec` in situations for which <a href="../AsyncFeatureSpec.html">`AsyncFeatureSpec`</a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. ''Note: `fixture.AsyncFeatureSpec` is intended for use in special situations, with class `AsyncFeatureSpec` used for general needs. For
 * more insight into where `fixture.AsyncFeatureSpec` fits in the big picture, see the <a href="../AsyncFeatureSpec.html#withFixtureOneArgAsyncTest">`withFixture(OneArgAsyncTest)`</a> subsection of the <a href="../AsyncFeatureSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `AsyncFeatureSpec`.''
 * </td></tr></table>
 *
 * Class `fixture.AsyncFeatureSpec` behaves similarly to class `org.scalatest.AsyncFeatureSpec`, except that tests may have a
