 ...
 * '''Recommended Usage''':
 * Use class `fixture.FreeSpec` in situations for which <a href="../FreeSpec.html">`FreeSpec`</a>
 ...
 * more insight into where `fixture.FreeSpec` fits in the big picture, see the <a href="../FreeSpec.html#withFixtureOneArgTest">`withFixture(OneArgTest)`</a> subsection of the <a href="../FreeSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `FreeSpec`.''
 * </td></tr></table>
 * 
