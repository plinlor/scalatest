 ...
 * '''Recommended Usage''':
 * Use class `fixture.AsyncWordSpec` in situations for which <a href="../AsyncWordSpec.html">`AsyncWordSpec`</a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. ''Note: `fixture.AsyncWordSpec` is intended for use in special situations, with class `AsyncWordSpec` used for general needs. For
 * more insight into where `fixture.AsyncWordSpec` fits in the big picture, see the <a href="../AsyncWordSpec.html#withFixtureOneArgAsyncTest">`withFixture(OneArgAsyncTest)`</a> subsection of the <a href="../AsyncWordSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class `AsyncWordSpec`.''
 * </td></tr></table>
 *
 * Class `fixture.AsyncWordSpec` behaves similarly to class `org.scalatest.AsyncWordSpec`, except that tests may have a
