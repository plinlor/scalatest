 ...
 * using a style consistent with traditional `FreeSpec` tests.
 *
 * <table><tr><td class="usage">
 * '''Recommended Usage''':
 * `AsyncFreeSpec` is intended to enable users of <a href="FreeSpec.html">`FreeSpec`</a>
 ...
 * In short, you structure an `AsyncFreeSpec` exactly like a `FreeSpec`, but with
 * tests having result type `Assertion` or `Future[Assertion]`. For more examples
 * of structure, see the documentation for <a href="FreeSpec.html">`FreeSpec`</a>.
 * 
 *
 ...
 *
 * `AsyncFreeSpec` extends <a href="AsyncTestSuite.html">`AsyncTestSuite`</a>, which provides an
 ...
 * traditional <a href="FreeSpec.html">`FreeSpec`</a> with
 ...
 * run in parallel very much like traditional (such as <a href="FreeSpec.html">`FreeSpec`</a>) tests run in
 ...
 *
 * One of the parameters to `AsyncFreeSpec`'s `run` method is a <a href="Reporter.html">`Reporter`</a>, which
 ...
 * the <a href="GivenWhenThen.html">`GivenWhenThen`</a> trait provides methods that use the implicit `info` provided by `AsyncFreeSpec`
 ...
 *
 * `AsyncFreeSpec` also provides a `markup` method that returns a <a href="Documenter.html">`Documenter`</a>, which allows you to send
 ...
 * create a matching tag for `AsyncFreeSpec`s like this:
 * 
 *
 * {{{  <!-- class="stHighlight" -->
 ...
 * method defined in trait <a href="AsyncTestSuite.html">`AsyncTestSuite`</a>, a supertrait of `AsyncFreeSpec`.
 * 
 *
 ...
 * the <a href="fixture/AsyncFreeSpec.html">documentation for `fixture.AsyncFreeSpec`</a>.
 * 
 *
 ...
 * between different `AsyncFreeSpec`s, however, you could also define them in a separate trait that is mixed into
