...
/**
 * Abstract class for the optional formatter objects that must be passed to the `Event`s reported
 ...
 * }}}
 *
 * ScalaTest suites should generate two events per test, a <a href="TestStarting.html">`TestStarting`</a> event and either
 * a <a href="TestSucceeded.html">`TestSucceeded`</a> or a <a href="TestFailed.html">`TestFailed`</a> event. The <a href="../FunSpec.html">`FunSpec`</a> trait does report both events,
 ...
 * `TestFailed` event, which is sent with an <a href="IndentedText.html">`IndentedText`</a> formatter instead of
...
/**
 * A <a href="Formatter.html">`Formatter`</a> providing information that enables reporters to create more stylized output.
 *
 * An example is that specification-style suites, such as <a href="../FunSpec.html">`FunSpec`</a>, generate output that reads
 ...
 *
 * <ul>
 * <li><a href="InfoProvided.html">`InfoProvided`</a> reported with an:
 * {{{  <!-- class="stHighlight" -->
 *   IndentedText(
 ...
 * }}}
 * </li>
 * <li><a href="TestSucceeded.html">`TestSucceeded`</a> reported with an:
 * {{{  <!-- class="stHighlight" -->
 *   IndentedText(
 ...
 * }}}
 * </li>
 * <li>`TestSucceeded` reported with an:
 * {{{  <!-- class="stHighlight" -->
 *   IndentedText(
